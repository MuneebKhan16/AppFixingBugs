...
const Data = [
  {
    id: 1,
    name: 'Feature your event across the top and on the featured events page',
    title: 'Featured Post',
    price: '$15',
    buttoname: 'Buy'
  },
  {
    id: 2,
    name: 'Subscribe a month-to-month package to avail all the features',
  ...
  {
    id: 3,
    name: 'Subscribe a monthly recurring package to avail all the features',
